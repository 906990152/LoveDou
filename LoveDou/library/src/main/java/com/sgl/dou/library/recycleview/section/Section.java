package com.sgl.dou.library.recycleview.section;

import android.content.Context;
import android.view.View;

import com.sgl.dou.library.recycleview.base.RecyclerViewHolder;
...
public abstract class Section {
    ...
    /**
     * Bind the data to the RecyclerViewHolder for the Content of this Section, that can be the Items,
     * Loading view or Failed view, depending on the current state of the section
     * @param holder RecyclerViewHolder for the Content of this Section
     * @param position position of the item in the Section, not in the RecyclerView
     */
    public final void onBindContentViewHolder(RecyclerViewHolder holder, int position) {
        switch (state) {
            case LOADING:
    ...
    /**
     * Return the RecyclerViewHolder for the Header of this Section
     * @param view View inflated by resource returned by getHeaderResourceId
     * @return RecyclerViewHolder for the Header of this Section
     */
    public RecyclerViewHolder getHeaderViewHolder(Context context, View view) {
        return new SectionRVAdapter.EmptyRecyclerViewHolder(context,view);
    }

    /**
     * Bind the data to the RecyclerViewHolder for the Header of this Section
     * @param holder RecyclerViewHolder for the Header of this Section
     */
    public void onBindHeaderViewHolder(RecyclerViewHolder holder) {
        // Nothing to bind here.
    }

    /**
     * Return the RecyclerViewHolder for the Footer of this Section
     * @param view View inflated by resource returned by getFooterResourceId
     * @return RecyclerViewHolder for the Footer of this Section
     */
    public RecyclerViewHolder getFooterViewHolder(Context context, View view) {
        return new SectionRVAdapter.EmptyRecyclerViewHolder(context,view);
    }

    /**
     * Bind the data to the RecyclerViewHolder for the Footer of this Section
     * @param holder RecyclerViewHolder for the Footer of this Section
     */
    public void onBindFooterViewHolder(RecyclerViewHolder holder) {
        // Nothing to bind here.
    }

    /**
     * Return the RecyclerViewHolder for a single Item of this Section
     * @param view View inflated by resource returned by getItemResourceId
     * @return RecyclerViewHolder for the Item of this Section
     */
    public abstract RecyclerViewHolder getItemViewHolder(View view, int viewType);
    /**
     * Bind the data to the RecyclerViewHolder for an Item of this Section
     * @param holder RecyclerViewHolder for the Item of this Section
     * @param position position of the item in the Section, not in the RecyclerView
     */
    public abstract void onBindItemViewHolder(RecyclerViewHolder holder, int position);

    /**
     * Return the RecyclerViewHolder for the Loading state of this Section
     * @param view View inflated by resource returned by getItemResourceId
     * @return RecyclerViewHolder for the Loading state of this Section
     */
    public RecyclerViewHolder getLoadingViewHolder(Context context, View view) {
        return new SectionRVAdapter.EmptyRecyclerViewHolder(context,view);
    }
    /**
     * Bind the data to the RecyclerViewHolder for Loading state of this Section
     * @param holder RecyclerViewHolder for the Loading state of this Section
     */
    public void onBindLoadingViewHolder(RecyclerViewHolder holder) {
        // Nothing to bind here.
    }

    /**
     * Return the RecyclerViewHolder for the Failed state of this Section
     * @param view View inflated by resource returned by getItemResourceId
     * @return RecyclerViewHolder for the Failed of this Section
     */
    public RecyclerViewHolder getFailedViewHolder(Context context, View view) {
        return new SectionRVAdapter.EmptyRecyclerViewHolder(context,view);
    }
    /**
     * Bind the data to the RecyclerViewHolder for the Failed state of this Section
     * @param holder RecyclerViewHolder for the Failed state of this Section
     */
    public void onBindFailedViewHolder(RecyclerViewHolder holder) {
        // Nothing to bind here.
    }
}
