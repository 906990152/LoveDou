...
import com.sgl.dou.rxretrofitlibrary.exception.CodeException;
import com.sgl.dou.rxretrofitlibrary.exception.HttpTimeException;
import com.sgl.dou.rxretrofitlibrary.http.cookie.CookieResulte;
import com.sgl.dou.rxretrofitlibrary.listener.HttpOnNextListener;
import com.sgl.dou.rxretrofitlibrary.utils.BaseUtil;
import com.sgl.dou.rxretrofitlibrary.utils.CookieDbUtil;
...
public class ProgressSubscriber<T> extends Subscriber<T> {
    ...
    private void errorDo(Throwable e) {
        ...
        if (e instanceof ApiException) {
            ...
            httpOnNextListener.onError(new ApiException(e, CodeException.JSON_ERROR, "json解析异常"));
        } else {
