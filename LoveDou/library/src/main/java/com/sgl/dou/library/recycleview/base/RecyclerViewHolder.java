package com.sgl.dou.library.recycleview.base;
...
import com.sgl.dou.library.recycleview.utils.ImageDisplayUtil;
...
public class RecyclerViewHolder extends RecyclerView.ViewHolder {
    ...
    {
        ImageView view = getView(viewId);
        ImageDisplayUtil.displayImg(mContext,url,view);
        return this;
    }

    public RecyclerViewHolder setImageByUrl(ImageView view, String url)
    {
        ImageDisplayUtil.displayImg(mContext,url,view);
        return this;
    }
    public RecyclerViewHolder setImageByUrl(int viewId, String url, int res)
    {
        ImageView view = getView(viewId);
        ImageDisplayUtil.displayImg(mContext,url,view,res);
        return this;
    }

    public RecyclerViewHolder setImageRoundByUrl(int viewId, String url)
    {
        ImageView view = getView(viewId);
        ImageDisplayUtil.displayRoundImage(mContext,url,view);
        return this;
    }

    public RecyclerViewHolder setImageCircleByUrl(int viewId, String url)
    {
        ImageView view = getView(viewId);
        ImageDisplayUtil.displayCircleImage(mContext,url,view);
        return this;
    }
    public RecyclerViewHolder setImageCircleByUrl(ImageView view, String url)
    {
        ImageDisplayUtil.displayCircleImage(mContext,url,view);
        return this;
    }
    ...
    public RecyclerViewHolder setImageRoundByUrl(int viewId, String url,int radio)
    {
        ImageView view = getView(viewId);
        ImageDisplayUtil.displayRoundImage(mContext,url,view,radio);
        return this;
    }
    public RecyclerViewHolder setImageRoundByUrl(ImageView view, String url)
    {
        ImageDisplayUtil.displayRoundImage(mContext,url,view);
        return this;
    }

    public RecyclerViewHolder setImageRoundByUrl(ImageView view, String url,int radio)
    {
        ImageDisplayUtil.displayRoundImage(mContext,url,view,radio);
        return this;
    }
