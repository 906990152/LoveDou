 ...
 * </p>
 * <p>
 * In addition, the pattern <code>'ZZ'</code> has been made to represent ISO8601 full
 * format time zones (eg. <code>+08:00</code> or <code>-11:00</code>). This
...
public class FastDateFormat extends Format {
     ...
     * @throws IllegalArgumentException if the Locale has no date pattern
     *             defined
     * @since 2.1
     */
     ...
     *             defined
     */
    public static synchronized FastDateFormat getDateInstance(int style, TimeZone timeZone,
            Locale locale) {
     ...
     * @throws IllegalArgumentException if the Locale has no time pattern
     *             defined
     * @since 2.1
     */
     ...
     *             defined
     */
    public static synchronized FastDateFormat getTimeInstance(int style, TimeZone timeZone,
            Locale locale) {
        Object key = Integer.valueOf(style);
        if (timeZone != null) {
            key = new Pair(key, timeZone);
     ...
     *             defined
     */
    public static synchronized FastDateFormat getDateTimeInstance(int dateStyle, int timeStyle,
     ...
     * @param style the style to use <code>TimeZone.LONG</code> or
     *            <code>TimeZone.SHORT</code>
     * @param locale the locale to use
     * @return the textual name of the time zone
     */
    static synchronized String getTimeZoneDisplay(TimeZone tz, boolean daylight, int style,
                                                  Locale locale) {
     ...
     *
     * @param pattern {@link SimpleDateFormat} compatible pattern
     * @param timeZone time zone to use, <code>null</code> means use default for
        ...
        for (int i = 0; i < length; i++) {
            ...
            switch (c) {
                ...
                case 'z': // time zone (text)
                    if (tokenLen >= 4) {
                        rule = new TimeZoneNameRule(mTimeZone, mTimeZoneForced, mLocale,
                                TimeZone.LONG);
                    } else {
                        rule = new TimeZoneNameRule(mTimeZone, mTimeZoneForced, mLocale,
                                TimeZone.SHORT);
    ...
    private static class TimeZoneNameRule implements Rule {
         ...
         * @param timeZoneForced if <code>true</code> the time zone is forced
         *            into standard and daylight
    ...
    private static class TimeZoneNumberRule implements Rule {
         ...
         * specified properties.
         * 
         * @param colon add colon between HH and MM in the output if
         *            <code>true</code>
         */
    ...
    private static class TimeZoneDisplayKey {
         ...
         * 
         * @param timeZone the time zone
         * @param daylight adjust the style for daylight saving time if
         *            <code>true</code>
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof TimeZoneDisplayKey) {
                ...
                return mTimeZone.equals(other.mTimeZone) && mStyle == other.mStyle
