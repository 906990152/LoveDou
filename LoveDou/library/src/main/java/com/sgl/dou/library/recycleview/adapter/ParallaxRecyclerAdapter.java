package com.sgl.dou.library.recycleview.adapter;
...
/*
    private void createAdapter(RecyclerView recyclerView) {
        ...
        final ParallaxRecyclerAdapter<String> adapter = new ParallaxRecyclerAdapter<String>(content) {
            @Override
            public void onBindViewHolderImpl(RecyclerView.RecyclerViewHolder viewHolder, ParallaxRecyclerAdapter<String> adapter, int i) {
                ((RecyclerViewHolder) viewHolder).textView.setText(adapter.getData().get(i));
            }

            @Override
            public RecyclerView.RecyclerViewHolder onCreateViewHolderImpl(ViewGroup viewGroup, final ParallaxRecyclerAdapter<String> adapter, int i) {
                return new RecyclerViewHolder(getLayoutInflater().inflate(R.layout.row_recyclerview, viewGroup, false));
            }
