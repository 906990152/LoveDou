 ...
 */
public class SectionRVAdapter extends RecyclerView.Adapter<RecyclerViewHolder> {
            ...
            if (viewType >= entry.getValue() && viewType < entry.getValue() + VIEW_TYPE_QTY) {
                ...
                switch (sectionViewType) {
                    case VIEW_TYPE_HEADER: {
                        ...
                        recyclerViewHolder = section.getHeaderViewHolder(mContext,view);
                        break;
                    }
                    case VIEW_TYPE_FOOTER: {
                        ...
                        recyclerViewHolder = section.getFooterViewHolder(mContext,view);
                        break;
                    }
                    case VIEW_TYPE_ITEM_LOADED: {
                        ...
                        recyclerViewHolder = section.getItemViewHolder(view,viewType);
                        break;
                    }
                    case VIEW_TYPE_LOADING: {
                        ...
                        recyclerViewHolder = section.getLoadingViewHolder(mContext,view);
                        break;
                    }
                    case VIEW_TYPE_FAILED: {
                        ...
                        recyclerViewHolder = section.getFailedViewHolder(mContext,view);
                        break;
                    }
                    default:
    ...
    /**
     * A concrete class of an empty RecyclerViewHolder.
     * Should be used to avoid the boilerplate of creating a RecyclerViewHolder class for simple case
     * scenarios.
     */
    public static class EmptyRecyclerViewHolder extends RecyclerViewHolder {
        public EmptyRecyclerViewHolder(Context context, View itemView) {
